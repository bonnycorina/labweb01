...
import com.brc.ms.proyectos.exception.EntityNotFoundExceptionMessages;
import com.brc.ms.proyectos.exception.IllegalOperationException;
import com.brc.ms.proyectos.repositories.InvestigadorRepository;
...
public class InvestigadorServiceImp implements InvestigadorService {
	...
	@Override
	@Transactional
	public List<Investigador> listarTodo() {
